...
Locator: locator('.body_utiDG')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.body_utiDG')

    at ReleasePage.verifyReleasePage (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:49:46)
