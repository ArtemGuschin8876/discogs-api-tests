...
export class Environment {
  public static USER_AGENT = process.env.USER_AGENT;
  ...
  public static USER_PASSWORD = process.env.USER_PASSWORD!;
  public static PERSONAL_TOKEN = process.env.PERSONAL_TOKEN;
