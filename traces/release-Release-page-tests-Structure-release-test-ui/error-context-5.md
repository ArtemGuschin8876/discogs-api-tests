...
Locator: locator('.table_c5ftk tr:nth-child(4) td')
Expected string: "2015"
Received string: "Japan"
Call log:
  - expect.soft.toContainText with timeout 5000ms
  - waiting for locator('.table_c5ftk tr:nth-child(4) td')
    3 × locator resolved to <td>…</td>
      - unexpected value "Japan"

    at ReleasePage.verifyReleaseStructure (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:62:51)
