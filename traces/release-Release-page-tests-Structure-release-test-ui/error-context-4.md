...
Locator: locator('.table_c5ftk tr:nth-child(3) td')
Expected string: "Japan"
Received string: "CD, Album, Reissue, Remastered"
Call log:
  - expect.soft.toContainText with timeout 5000ms
  - waiting for locator('.table_c5ftk tr:nth-child(3) td')
    3 × locator resolved to <td>…</td>
      - unexpected value "CD, Album, Reissue, Remastered"

    at ReleasePage.verifyReleaseStructure (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:61:54)
