...
- Location: C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\tests\release.spec.ts:10:7
...
Locator: locator('.table_c5ftk tr:nth-child(2) td')
Expected string: "CD"
Received string: "Tower Records X Sony Music Japan International スペジャルセレクション Vol.1"
Call log:
  - expect.soft.toContainText with timeout 5000ms
  - waiting for locator('.table_c5ftk tr:nth-child(2) td')
    8 × locator resolved to <td>…</td>
      - unexpected value "Tower Records X Sony Music Japan International スペジャルセレクション Vol.1"

    at ReleasePage.verifyReleaseStructure (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:59:61)
    at C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\tests\release.spec.ts:12:35
```
