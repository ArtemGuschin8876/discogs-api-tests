...
Locator: locator('.table_c5ftk tr:nth-child(6) td')
Expected string: "Psychedelic Rock, Pop Rock"
Received string: "Rock, Pop"
Call log:
  - expect.soft.toContainText with timeout 5000ms
  - waiting for locator('.table_c5ftk tr:nth-child(6) td')
    3 × locator resolved to <td>…</td>
      - unexpected value "Rock, Pop"

    at ReleasePage.verifyReleaseStructure (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:64:52)
