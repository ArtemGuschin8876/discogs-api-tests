...
```
Error: locator.click: Error: strict mode violation: locator('button').filter({ hasText: 'Remove' }) resolved to 5 elements:
    ...
    2) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded 26 hours ago Remove$/ }).getByRole('button')
    3) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded 42 minutes ago Remove$/ }).getByRole('button')
    4) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded 34 minutes ago Remove$/ }).getByRole('button')
    5) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded just now Remove$/ }).getByRole('button')
