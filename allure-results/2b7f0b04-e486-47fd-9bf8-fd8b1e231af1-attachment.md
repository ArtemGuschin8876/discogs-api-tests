...
Locator: locator('.table_c5ftk tr:nth-child(1) td')
Expected string: "SAR (3) – AICL 3311~2"
Received: <element(s) not found>
Call log:
  - expect.soft.toContainText with timeout 5000ms
  - waiting for locator('.table_c5ftk tr:nth-child(1) td')

    at ReleasePage.verifyReleaseStructure (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:59:52)
