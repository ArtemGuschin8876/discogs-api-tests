...
```
Error: locator.click: Error: strict mode violation: locator('button.remove_rguzu') resolved to 6 elements:
    1) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('.button_PgYDF').first()
    2) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div:nth-child(3) > .header_pVpwr > .button_PgYDF')
    3) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div:nth-child(4) > .header_pVpwr > .button_PgYDF')
    4) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div:nth-child(5) > .header_pVpwr > .button_PgYDF')
    5) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded 112 minutes ago Remove$/ }).getByRole('button')
    6) <button type="button" class="button_PgYDF link_ijVx7 small_VmGxx remove_rguzu"> Remove</button> aka locator('div').filter({ hasText: /^In CollectionAdded just now Remove$/ }).getByRole('button')

Call log:
  - waiting for locator('button.remove_rguzu')

    at ReleasePage.removeFromCollectionAndVerifyTable (C:\Users\Artemka\pw-learn\discogs-api-tests\src\ui\pages\release.page.ts:75:37)
